...
# # On-board LEDs
set_property -dict {PACKAGE_PIN C13 IOSTANDARD LVCMOS33} [get_ports {LED[0][0]}];     # LED[0 ] 
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports {LED[0][1]}];     # LED[1 ] 
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {LED[0][2]}];     # LED[2 ] 
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports {LED[0][3]}];     # LED[3 ] 
set_property -dict {PACKAGE_PIN D16 IOSTANDARD LVCMOS33} [get_ports {LED[0][4]}];     # LED[4 ] 
set_property -dict {PACKAGE_PIN F18 IOSTANDARD LVCMOS33} [get_ports {LED[0][5]}];     # LED[5 ] 
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports {LED[0][6]}];     # LED[6 ] 
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS33} [get_ports {LED[0][7]}];     # LED[7 ] 
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33} [get_ports {LED[1][0]}];     # LED[8 ] 
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports {LED[1][1]}];     # LED[9 ] 
set_property -dict {PACKAGE_PIN A17 IOSTANDARD LVCMOS33} [get_ports {LED[1][2]}];     # LED[10] 
set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS33} [get_ports {LED[1][3]}];     # LED[11] 
set_property -dict {PACKAGE_PIN C18 IOSTANDARD LVCMOS33} [get_ports {LED[1][4]}];     # LED[12] 
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports {LED[1][5]}];     # LED[13] 
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports {LED[1][6]}];     # LED[14] 
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports {LED[1][7]}];     # LED[15] 
...
set_property -dict {PACKAGE_PIN E4 IOSTANDARD LVCMOS25} [get_ports {anode[1][0]}];  # 0 Active LOW
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS25} [get_ports {anode[1][1]}];  # 1 Active LOW
set_property -dict {PACKAGE_PIN F5 IOSTANDARD LVCMOS25} [get_ports {anode[1][2]}];  # 2 Active LOW
set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS25} [get_ports {anode[1][3]}];  # 3 Active LOW
...
# PMOD A Signals
# set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33} [get_ports {JA1_P}];     # JA1_P
# set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS33} [get_ports {JA1_N}];     # JA1_N
# set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS33} [get_ports {JA2_P}];     # JA2_P
# set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {JA2_N}];     # JA2_N
# set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {JA3_P}];     # JA3_P
# set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {JA3_N}];     # JA3_N
# set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS33} [get_ports {JA4_P}];     # JA4_P
# set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports {JA4_N}];     # JA4_N

# PMOD B Signals
# LCD DISPLAY 2x
# pmod_cathode = {G,F,E,D,C,B,A} 
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[5]}];       # F   PIN 1   JB1_P
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[4]}];       # E   PIN 2   JB1_N
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[1]}];       # B   PIN 3   JB2_P
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[2]}];       # C   PIN 4   JB2_N
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[6]}];       # G   PIN 7   JB3_P
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[3]}];       # D   PIN 8   JB3_N
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {pmod_cathode[0]}];       # A   PIN 9   JB4_P
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33} [get_ports {pmod_anodeSel}];         # S   PIN 10  JB4_N
