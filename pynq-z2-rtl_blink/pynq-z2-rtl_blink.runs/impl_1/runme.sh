...
HD_PWD='C:/Users/vince/Documents/xilinx/pynq-z2-rtl_blink/pynq-z2-rtl_blink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainSesign_wrapper.tcl -notrace
