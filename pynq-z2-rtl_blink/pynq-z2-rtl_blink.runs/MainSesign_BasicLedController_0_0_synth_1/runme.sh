...
HD_PWD='C:/Users/vince/Documents/xilinx/pynq-z2-rtl_blink/pynq-z2-rtl_blink.runs/MainSesign_BasicLedController_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSesign_BasicLedController_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainSesign_BasicLedController_0_0.tcl
