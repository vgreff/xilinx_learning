...
HD_PWD='C:/Users/vince/Documents/xilinx/pynq-z2-rtl_blink/pynq-z2-rtl_blink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainSesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainSesign_wrapper.tcl
